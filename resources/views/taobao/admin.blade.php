...
<div class="d-flex flex-column">
	...
	<div class="text-center my-4"><a href="{{ route('taobao.admin.linked', ['shop' => $shop,]) }}" class="mdc-typography--headline5">已关联商品</a></div>
	<div class="text-center my-4"><a href="{{ route('taobao.admin.ignored', ['shop' => $shop,]) }}" class="mdc-typography--headline5">已忽略商品</a></div>
</div>
@endsection
